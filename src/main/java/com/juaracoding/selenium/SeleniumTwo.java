...
public class SeleniumTwo {
    public static void main(String[] args) {
        ...
        System.out.println("Yes impressiveRadio Clicked");
        delay(detik);
        ...
        delay(detik);
        oldSelectMenu.selectByVisibleText("Indigo");
